...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMBuscarTelefono.setText("Buscar Telefonos");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(Escritorio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 727, Short.MAX_VALUE)
        );
    ...
    private void jMAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMAgregarActionPerformed
        ...
        Escritorio.repaint();
        VistasAgregarCliente vac = new VistasAgregarCliente();
        vac.setVisible(true);
        Escritorio.add(vac);
    ...
    private void jMBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMBuscarActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        VistasBuscarCliente vbc = new VistasBuscarCliente();
        vbc.setVisible(true);
        Escritorio.add(vbc);
    ...
    private void jMBuscarTelefonoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMBuscarTelefonoActionPerformed
        // TODO add your handling code here:
         Escritorio.removeAll();
        Escritorio.repaint();
        VistasBuscarTelefono vbt = new VistasBuscarTelefono();
        vbt.setVisible(true);
        Escritorio.add(vbt);
